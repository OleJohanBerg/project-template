...
HD_PWD='/home/tetsuya/fpga/rocket-chip-template/vprj/TinyLance.runs/SlowClock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SlowClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SlowClock.tcl

...
HD_PWD='/home/tetsuya/fpga/rocket-chip-template/vprj/TinyLance.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TinyLanceTestHarness.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TinyLanceTestHarness.tcl -notrace

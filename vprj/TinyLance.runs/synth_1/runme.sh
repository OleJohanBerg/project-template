...
HD_PWD='/home/tetsuya/fpga/rocket-chip-template/vprj/TinyLance.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TinyLanceTestHarness.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TinyLanceTestHarness.tcl
